...
<body>
    ...
    <form method="POST" action="">
            ...
            <?php else: ?>
                <?php foreach ($book_authors as $author): ?>
                    <div class="author-item" style="margin-top: 8px;">
                        ...
                        <button type="button" class="remove-btn" onclick="removeAuthor(<?= $author['id'] ?>)">
                            Eemalda
                        </button>
                    </div>
                <?php endforeach; ?>
        ...
        <div style="margin-top: 20px;">
            ...
            <a href="book.php=<?= $id ?>" class="btn-back">Tagasi</a>
        </div>
    </form>
    ...
    <script>
        ...
        // Close dropdown when clicking outside, but not when clicking checkboxes
        ...
        // Remove author function
        function removeAuthor(authorId) {
            if (confirm('Kas oled kindel, et soovid seda autorit eemaldada?')) {
